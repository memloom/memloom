...
[`import claude-code`](/concepts/distillation), the transcript excerpt it was distilled
...
<Note>
This is the same one-shot judge that resolves some conflicts during `import claude-code`
