...
Run the store daemon in the foreground: the HTTP API on 4319, the viewer, and the Postgres
wire on 54329. The daemon is the single owner of the store; every other command talks to it
over HTTP (and auto-starts it when needed). Ctrl+C to stop.
