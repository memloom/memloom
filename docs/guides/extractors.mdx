...
~200 characters of overlap carried across boundaries. These are research-consensus defaults,
sized in characters on purpose: a tokenizer dependency buys nothing when the embedding model
has ~20× context headroom.
