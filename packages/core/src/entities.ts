...
export function buildEntityPrompt(
  ...
  return [
    ...
    '- exercise or task phrasing in any language ("Calcula el área del triángulo", "solve for the unknown")',
    '- generic domain words in any language ("fórmula", "Aufgabe", "equation", "derivative")',
    ...
    'BAD entity: {"name":"y = x^3 - 2x^2"} (a formula), {"name":"fórmula"} (generic word),',
    '            {"name":"the maximum value on the interval"} (sentence fragment)',
    "",
